...
namespace AC
{
	...
	public class PathsEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			_target.nodePause = CustomGUILayout.FloatField ("Wait time (s):", _target.nodePause, "", "The time, in seconds, that a character will wait at each node before continuing along the path");
